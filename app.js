...
let sum = (a, b, c, d) => a + b + c + d;  //solved

// TODO: Uncomment the following line of code to see the output in the browser console
// console.log(sum(1, 2, 3, 4));

let objectLit =  ()=> ({key1: "value1",key2: "value2",key3: "value3",}); //solved

// TODO: Uncomment the following line of code to see the output in the browser console
// console.log(objectLit());

let sumAndProduct = (a, b)=> {  //solved
  let sum = a + b;
  let product = a * b;
  return [sum, product];
};
...
let message = name => {return `Hello, ${name}!`;}; //solved
...
Student.prototype.greeting =  function() {return `Hi, my name is ${this.name}`;};// Not Solved
...
Student.prototype.scope = function () { // <Here will call the the function itself>
  console.log(this);
};
...
Student.prototype.scopeArrow = () => console.log(this);// <Here Will call the window object>
...
//   Here will call the the function itself (scope() function scope)
// 2. What is "this" when joe.scopeArrow() is invoked?
//   Here Will call the window object (window object scope)
// 3. Explain why "this" is different when an arrow function is used.
//   Because it's refer to the global object
